...
public class Pico8RetstatImpl extends ASTWrapperPsiElement implements Pico8Retstat {

  public Pico8RetstatImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Pico8Visitor visitor) {
    visitor.visitRetstat(this);
  }
