...
public class Pico8ExplistImpl extends ASTWrapperPsiElement implements Pico8Explist {

  public Pico8ExplistImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Pico8Visitor visitor) {
    visitor.visitExplist(this);
  }
