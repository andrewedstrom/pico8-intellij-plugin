...
public class Pico8FunctiondefImpl extends ASTWrapperPsiElement implements Pico8Functiondef {

  public Pico8FunctiondefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Pico8Funcbody getFuncbody() {
    return findNotNullChildByClass(Pico8Funcbody.class);
  }
