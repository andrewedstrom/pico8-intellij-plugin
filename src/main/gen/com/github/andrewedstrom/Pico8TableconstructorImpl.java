...
public class Pico8TableconstructorImpl extends ASTWrapperPsiElement implements Pico8Tableconstructor {

  public Pico8TableconstructorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public Pico8Fieldlist getFieldlist() {
    return findChildByClass(Pico8Fieldlist.class);
  }
